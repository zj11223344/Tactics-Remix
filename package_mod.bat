...
set "mod_name=Tactics Remix"
set "mod_version=v0.1.1-alpha"
set mod_folder=tactics-remix
...
set mod_readme=https://github.com/Gibberlings3/Tactics-Remix/blob/main/README.md
